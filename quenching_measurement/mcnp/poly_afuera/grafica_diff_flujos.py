...
"""
Script para comparar flujo de partículas entre espectros con y sin poly
"""
...
if __name__ == '__main__':
    ...
    fig_n.tight_layout()
    fig_p.tight_layout()
    fig_n.savefig('diff_flux_vac_poly_neutrons.png')
    fig_p.savefig('diff_flux_vac_poly_photons.png')
    plt.show()
