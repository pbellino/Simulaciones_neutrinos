...
\title{Avances en la simulación para optimización del blindaje en $\nu$IOLETA}
    \author[$\nu$VIOLETA]{Pablo Bellino}

\institute{Física Experimental de Reactores, CNEA}
...
\begin{frame}{Introducción}
    \begin{block}<+->{Objetivo}
        Validar una línea de cálculo para luego poder realizar la optimización del blindaje que se utilizará en el experimento $\nu$IOLETA.
      
    \end{block}
    \begin{block}<+->{Modelo}
        \begin{itemize}
          \item<+-> Será necesario simular partículas con un amplio rango de energías (1eV-1GeV)
          ...
          \item<+-> En esta charla se mostrarán los avances realizados para validar el modelado de un experimento con skippers-CCD con los programas MCNP y PHITS
          \item<+-> Se comienza trabajando en el rango de energías más cómodo (keV-MeV) donde los programas suelen funcionar muy bien
        \end{itemize}
    \end{block}
\end{frame}

\begin{frame}{¿Qué puede simular PHITS y MCNP6?}
    \begin{center}
        \includegraphics[height=6cm]{energy_range_mcnp.png}
    \end{center}

    Tanto PHITS como MCNP simulan fotones y electrones hasta 1keV (simulación actual). 
    Con MCNP6 se puede bajar hasta 1eV (fotones) y 10eV (fotones).
\end{frame}
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.6\textwidth}
            ...
            \begin{itemize}
                ...
                \item Dos bloques de cobre rodeando detector como blindaje (12" x 8" x 2")
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item Fuente de fisiones espontáneas de $^{252}$Cf (1.2$\mu$Ci) debajo del plomo(no visible en la imagen)
                \item Plomo como blindaje de los gammas producidos por la fuente
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Resultados: energía depositada en Si}
    \vspace{-1em}
    \begin{center}
...
\begin{frame}{Resultados: comparación con el experimento}
    \begin{center}
        \includegraphics[height=0.88\textheight]{comp_Cf252.pdf}
    \end{center}
\end{frame}

\section{contribución de los fotones del Cf}
...
\begin{frame}{Algunas respuestas}
   \begin{itemize}
       ...
       \item Se obtuvo la energía depositada en Si por fotones
   \end{itemize}
...
\begin{frame}{Pasos a seguir}
        \begin{itemize}
            \item Agregar la contribución del fondo (altas energías)
